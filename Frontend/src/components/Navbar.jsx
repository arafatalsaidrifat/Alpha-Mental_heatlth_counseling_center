...
function Navbar() {
  ...
  const handleMoreClick = () => {
    setIsAboutOpen((prev) => !prev); // Toggle dropdown
  };
      ...
      <li className="relative" ref={aboutRef}>
        ...
        {isAboutOpen && (
          <ul className="absolute left-0 mt-1 w-40 p-2 bg-white border rounded shadow-lg z-50">
            <li>
              <Link to="/packages" className="block p-2 hover:bg-gray-200" onClick={() => setIsAboutOpen(false)}>
                Packages
              </Link>
            </li>
            <li>
              <Link to="/payment" className="block p-2 hover:bg-gray-200" onClick={() => setIsAboutOpen(false)}>
                Payments
              </Link>
            </li>
            <li>
              <Link to="/livechat" className="block p-2 hover:bg-gray-200" onClick={() => setIsAboutOpen(false)}>
                Live Chat
              </Link>
            </li>
            {/* New "Session Booked" option */}
            <li>
              <Link to="/sessions" className="block p-2 hover:bg-gray-200" onClick={() => setIsAboutOpen(false)}>
                Session Booked
              </Link>
            </li>
          </ul>
            ...
            <div className="flex items-center justify-end flex-grow">
              <label className="swap swap-rotate mr-3">
                ...
                <svg
                  ...
                  xmlns="http://www.w3.org/www.svgs"
                  viewBox="0 0 24 24"
                >
